...
* [`src/myrf/`](src/myrf/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/myrf/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `myrf` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/myrf/config.cljs) defaults to `true` in
